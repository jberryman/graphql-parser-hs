...
newtype Name = Name { unName :: Text }
  deriving (Eq, Ord, Show, Hashable, Lift, Semigroup, J.ToJSONKey, J.ToJSON, Data)
...
newtype ExecutableDocument var
  ...
  deriving (Ord, Show, Eq, Lift, Hashable, Functor, Foldable, Traversable, Data)
...
data ExecutableDefinition var
  ...
  deriving (Ord, Show, Eq, Lift, Functor, Foldable, Traversable, Generic, Data)
...
newtype SchemaDocument
  ...
  deriving (Ord, Show, Eq, Lift, Hashable, Generic, Data)
...
data Field frag var = Field
  ...
  } deriving (Ord, Show, Eq, Functor, Foldable, Traversable, Generic, Data)
...
data NoFragments var
  deriving (Eq, Ord, Show, Functor, Foldable, Traversable, Lift, Generic, Data)
...
newtype Nullability
  ...
  deriving (Show, Ord, Eq, Lift, Generic, Hashable, Data)

data GType
  = TypeNamed Nullability Name
  | TypeList Nullability GType
  deriving (Eq, Ord, Show, Lift, Generic, Data)
...
data TypeDefinition possibleTypes inputType
  ...
  deriving (Ord, Show, Eq, Lift, Generic, Functor, Data)
...
newtype Description
  ...
  deriving (Show, Eq, Ord, IsString, Lift, Semigroup, Monoid, Hashable, J.ToJSON, J.FromJSON, Data)
...
newtype EnumValue
  ...
  deriving (Show, Eq, Lift, Hashable, J.ToJSON, J.FromJSON, Ord, Data)
